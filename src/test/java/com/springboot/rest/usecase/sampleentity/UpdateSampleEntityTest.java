...
class UpdateSampleEntityTest {
    ...
    @InjectMocks
    private UpdateReadThroughEntity updateReadThroughEntity;
    ...
    public void init() {
        ...
        updateReadThroughEntity = new UpdateReadThroughEntity(sampleEntity2ServicePort);
    }
    ...
    void updateSampleEntityTest() {
    	Mockito.when(sampleEntity2ServicePort
    			...
    			.thenReturn(null);    	
    	ReadThroughEntity updatedSampleEntity = updateReadThroughEntity.update(DEFAULT_ID, sampleEntityDto);
    ...
    void patchSampleEntityTest() {
    	Mockito.when(sampleEntity2ServicePort
    			...
    			.thenReturn(null);    	
    	Optional<ReadThroughEntity> patchedSampleEntity = updateReadThroughEntity.patch(DEFAULT_ID, sampleEntityDto);
